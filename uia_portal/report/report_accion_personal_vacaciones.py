...
class AccionPersonalReport(models.AbstractModel):
    ...
    def get_accion_personal_vacaciones(self,solicitudVacaciones):
        ...
        timezoneJefatura = pytz.timezone(solicitudVacaciones.empleado_id.department_id.manager_id.resource_id.tz)
        ...
        return {
            ...
            'firmaJefaturaNombre': solicitudVacaciones.empleado_id.department_id.manager_id.name,
            'firmaJefaturaUsuario': solicitudVacaciones.empleado_id.department_id.manager_id.work_email,
